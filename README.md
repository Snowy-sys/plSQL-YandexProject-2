...
## Ревью
Результат ревью и отзыв по проекту размещен в [Comments.txt](https://github.com/Snowy-sys/plSQL-YandexProject-2/blob/main/Comments.txt)
...
#### Предусловия
Перед началом выполнения заданий необходимо развернуть базу данных из дампа [sprint2_dump](https://github.com/Snowy-sys/plSQL-YandexProject-2/blob/main/sprint2_dump.sql) и выполнить проект в два этапа. Этап №1: создание дополнительных таблиц. Этап №2: создание представлений и написание аналитических запросов. Оба этапа подробно описаны в [СР_2](https://github.com/Snowy-sys/plSQL-YandexProject-2/blob/main/CP_2.sql)
